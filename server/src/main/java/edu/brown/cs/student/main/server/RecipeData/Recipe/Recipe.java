...
public class Recipe {
   ...
   * @param spoonacularScore the rating given to this Recipe by Spoonacular, on a scale from 0
   *     (worst) - 100 (best)
  ...
  /**
   * Scales this Recipe's ingredients up to the multiple of the original servings closest to the
   * desired number of servings. If called with an attempt to scale down, will not modify this
   * Recipe.
   *
