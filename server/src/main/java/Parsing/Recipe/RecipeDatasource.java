...
public interface RecipeDatasource {
   ...
   */
  List<Recipe> queryRecipes(int numRecipes, String cuisine, String excludeCuisine, String diet, String intolerances, String excludeIngredients, int maxReadyTime) throws DatasourceException;
}
