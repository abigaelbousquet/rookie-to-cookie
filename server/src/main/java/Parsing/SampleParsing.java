...
public class SampleParsing {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      SearchResult deserializedSearchResult = SpoonacularRecipeUtilities.deserializeSearchResult(fileString);
...
//      FileWriter jsonWriter = new FileWriter("data/examplePARSEDSearchResult.json");
      ...
      bw.write(SpoonacularRecipeUtilities.searchResultAdapter.toJson(deserializedSearchResult));
      jsonWriter.close();
