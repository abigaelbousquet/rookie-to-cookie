...
public class TestEndpoint {
  ...
  @Test
  public void generateAndSaveMealplan() throws IOException {
    HttpURLConnection clientConnection =
        tryRequest(
            "generate-mealplan?uid=test&daysOfWeek=monday&mode=minimize&diet=&intolerances=&servings=4&cuisine=&max_time=80&exclude_cuisine=");
    assertEquals(200, clientConnection.getResponseCode());
  ...
  public void clearLikedRecipe() throws IOException {
    HttpURLConnection clientConnection = tryRequest("clear-liked-recipes?uid=test&recipeId=519398");
    assertEquals(200, clientConnection.getResponseCode());
    clientConnection.disconnect();
  }
  ...
  public void addDislikedRecipe() throws IOException {
    HttpURLConnection clientConnection = tryRequest("add-disliked-recipe?uid=test&recipeId=519398");
    assertEquals(200, clientConnection.getResponseCode());
    clientConnection.disconnect();
  }
}
