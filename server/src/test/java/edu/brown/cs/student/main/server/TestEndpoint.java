...
public class TestEndpoint {
  ...
  public void clearLikedRecipe() throws IOException {
    HttpURLConnection clientConnection =
        tryRequest("clear-liked-recipes?uid=2YtRmY2yYWO1OKarSPlFqtzdi6T2&recipeId=1676003");
    assertEquals(200, clientConnection.getResponseCode());
    clientConnection.disconnect();
  }
  ...
  public void addDislikedRecipe() throws IOException {
    HttpURLConnection clientConnection =
        tryRequest("add-disliked-recipe?uid=2YtRmY2yYWO1OKarSPlFqtzdi6T2&recipeId=1676003");
    assertEquals(200, clientConnection.getResponseCode());
    clientConnection.disconnect();
  }
  ...
  public void addLikedRecipe() throws IOException {
    HttpURLConnection clientConnection =
        tryRequest("add-liked-recipe?uid=2YtRmY2yYWO1OKarSPlFqtzdi6T2&recipeId=1676003");
    assertEquals(200, clientConnection.getResponseCode());
    clientConnection.disconnect();
  }
