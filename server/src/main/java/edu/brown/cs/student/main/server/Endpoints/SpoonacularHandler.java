...
public class SpoonacularHandler implements Route {
  ...
  public Object handle(Request request, Response response)
    ...
    try {
      ...
      String recipePath =
          "C:\\Users\\Faizah\\Documents\\Brown Sophomore Year\\CS0320\\term-project-mshaffe3-ddedona-ffnaqvi-abousque\\server\\data\\exampleRecipe.json";

      String recipeJson = new String(Files.readAllBytes(Paths.get(recipePath)));

      // Deserializes JSON into a recipe
      SpoonacularRecipeUtilities.Recipe returnedRecipe = SpoonacularRecipeUtilities.deserializeRecipe(recipeJson);
  ...
  public String sendRequest(String cuisine)
    ...
    HttpRequest buildSpoonacularApiRequest =
        HttpRequest.newBuilder()
            .uri(new URI("https://api.spoonacular.com/recipes/complexSearch?cuisine=" + cuisine))
            .GET()
            .build();
