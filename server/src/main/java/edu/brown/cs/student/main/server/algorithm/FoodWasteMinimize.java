...
public class FoodWasteMinimize {
    ...
    public FoodWasteMinimize(List<Recipe> allRecipes, StorageInterface firebaseData, String uid, int numDays) throws InterruptedException, ExecutionException, IllegalArgumentException, IOException {
