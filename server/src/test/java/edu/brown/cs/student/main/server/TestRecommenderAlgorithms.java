...
// import
// edu.brown.cs.student.main.server.RecommenderAlgorithm.MealPlanGeneratorUtilities.GeneratorUtilities;
...
// the
//    * results share the same ingredient of the most important ingredient to the first Recipe of
// the
//    * results.
//    */
//   @Test
...
//   /**
//    * Test personalized algorithm with a mocked query result and user who only has disliked
// Recipes
...
//     SearchResult mockedResult =
// deserializedMockedSearchResults("exampleQualityResultLength6.json");
...
//    *
//    * <p>Tests that the nearest neighbors to the disliked Recipe are never returned in results
// with
//    * SEVERAL DIFFERENT ORDERS OF CANDIDATE RECIPES (different trees) to verify consistent
// results.
//    */
//   @Test
...
//       for (Recipe recipe : results) {
//         if ((recipe.getId() == 1154142) || (recipe.getId() == 487780)) {
//           System.out.println("Recommendation included one of nearest neighbors to disliked
// recipe");
...
//    * associated with their uid. Tests that the nearest neighbors to the liked Recipe are returned
// as
//    * results.
//    */
//   @Test
...
//    * associated with their uid.
//    *
//    * <p>Tests that the nearest overall neighbor to the liked Recipes are ALWAYS returned in
// results
...
//     SearchResult mockedResult =
// deserializedMockedSearchResults("exampleQualityResultLength7.json");
