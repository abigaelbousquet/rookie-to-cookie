package edu.brown.cs.student.main.server;//package edu.brown.cs.student.main.server;
//
...
public class FuzzTestMealPlanGenerator {
    ...
    /**
     * Test to fuzz test the queries to see recipe volume exception
     * percentage; takes up queries when used with a Spoonacular recipe
     * source but for temporary time we use a mockedDatasource
     *
     * on average 30% of the time a RecipeVolumeException is thrown
     *
     ...
     */
    @Test
    public void testSimpleGeneratePlan() throws DatasourceException, RecipeVolumeException, ExecutionException, InterruptedException, IOException {
        // Test generatePlan method
    ...
    private void setUpMealPlanGenerator() throws ExecutionException, InterruptedException, IOException {
